...
const columns: ColumnsType<Compania> = [
  ...
  },
  {
    ...
    render: (_: unknown, r: Compania) => (
      <Text type="secondary">{r.cliente.nombre}</Text>
    ),
  },
  {
    title: "Tipo",
    ...
    render: (tipo: string | null) =>
      tipo ? <Tag color="blue">{tipo}</Tag> : <Text type="secondary">—</Text>,
  },
  {
    title: "Conceptos",
    key: "conceptos",
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <Text type="secondary">
          Vista consolidada de clientes, compañías y conceptos de nómina
        </Text>
      </div>
